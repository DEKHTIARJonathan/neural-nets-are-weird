...
#Notebook password configuration
c.NotebookApp.allow_credentials = True

# To change the default password run in shell : 

# python
# >>> from IPython.lib import passwd
# >>> passwd('yournewpassword') 
# Copy the output to this line : c.NotebookApp.password = u''

#Default Password is : neuralnet
c.NotebookApp.password = u'sha1:bf6aed8e3781:0d31699e3448c5d972efc7a608bd1449aac72458'
...
c.NotebookApp.certfile = u'/certificate/mycert.pem'
